...
public class ApplicationProperties {
    ...
    public static final String DEFAULT_JOB_SCHEDULED_TOPIC = "job-scheduled-A01";
    ...
    public String getTopicInsert() {
        return topicInsert;
    }

    public void setTopicInsert(String topicInsert) {
        this.topicInsert = topicInsert;
    }

    public String getTopicsUpdate() {
        return topicsUpdate;
    }

    public void setTopicsUpdate(String topicsUpdate) {
